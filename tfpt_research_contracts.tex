...
\veri{v798\_seam\_clifford\_modular\_s.py}).]}  \emph{No
...
(\textsc{rootclass-mixed}).  No marker move.
...
and is not claimed}.  \emph{Kill:} a finite positive packet whose
required GL1 intertwiner fails the exact Choi census structurally.
