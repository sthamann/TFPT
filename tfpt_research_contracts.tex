...
hypothesis (H) on the cofinal ladder.  Demand, kill and close
conditions unchanged; still [O].]
...
the canonical cofinal $(D, X)$ ladder ($D_j = 2^{-j}$,
...
cofinal finite positivity of the tower forms --- every ladder
...
$C^0$-continuity of $Q_W$ at fixed support; Weil 1952, Bombieri
...
\texttt{PRIME.RELATION.SKELETON.01} restricted to the cofinal
ladder --- and \emph{nothing else}.  \emph{Kill:} an element of
...
strictly monotone ladder along which the tower matrices are PSD;
...
ladder.  \emph{The honest boundary:} $(H_{\rm cof})$ stays a
...
demand:} a proof of the embedding uniformly along a cofinal
window subfamily would discharge \texttt{SourceContractor}
