...
off the atoms: Suzuki's smooth layer is $-4\times$ the TFPT arch
...
\textbf{W1 status: theorem-capable at the window level} --- the
$L^2_0$ projection is the last remainder; \textbf{W2/W3 stay open and
unmoved}.
