...
completes.  The $Q/V$ operator dictionary and the real-structure map
are the named next steps; the gate does not move \mE/\mC.  The honest decomposition (spectrum ablation): freeing
