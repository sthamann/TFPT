...
\emph{relocated and shrunk}, not removed: the named residuals are
the doubly-even self-dual \emph{universe premise} (R1), the
semantic deck placement (R2) and the anchor naming (R3); no
P2-removal claim --- the open contract form is registered as
\texttt{ARF.BOUNDARY.CODE.01} \mO.
...
H4 partial).  Carrier mathematics only; the fired matter fence
...
vs channel $4/49$) stay in their registers.  Typing unchanged.
