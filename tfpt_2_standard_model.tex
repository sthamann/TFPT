...
R1--R3 typed (universe premise, semantic deck placement, anchor
naming); no P2-removal claim (\texttt{ARF.BOUNDARY.CODE.01} \mO).
\smallskip\\
...
$\Z_2$).  Stabilizer-formalism mathematics about the carrier; the
fired \textsc{rootclass-mixed} matter fence is unaffected; no
marker moves.
