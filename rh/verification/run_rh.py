...
Runs, in order:
  ...
  (2) PROBES     -- the sealed campaign probes r250-r367 from
...
# the sealed campaign probe list r250-r367 (order = round order); every
...
def check_probes(suite):
    section("(2) PROBES -- sealed campaign r250-r367, --smoke mode")
    py = python_bin()
