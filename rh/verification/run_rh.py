...
Runs, in order:
  (1) INTEGRITY  -- SHA-256 of every pinned rh/INVENTORY.json entry
                    ...
                    (2) PROBES     -- the sealed campaign probes r250-r409 from
...
# the sealed campaign probe list r250-r409 (order = round order); every
...
def check_probes(suite):
    section("(2) PROBES -- sealed campaign r250-r409, --smoke mode")
    py = python_bin()
