...
$125$ preregistered probes with $3139$ machine checks, which localized the residual object. That
...
$n=11\ldots125$). The probe file, the contract name, the verdict and the check count of every part are
...
certification degree, the honest RH distance); Section~\ref{sec:status} is the status statement.
...
throughout --- $430$ completed Cholesky certificates in total).\\[3pt]
...
$|r_{\mathrm{corr}}|=0.3888$--$14.8018$ with the norm-only variant returning exactly $0$; every
...
(Section~\ref{sec:balance}), and it is where the series closes.
...
% =====================================================================
\appendix
\section{Probe index, diary parts T11--T125}\label{app:index}
% =====================================================================
...
load-bearing artefact. The index covers the $115$ parts T11--T125 that the current diary file records
($116$ runs --- T104 was a double run with two independent arms --- and $2947$ green checks); the ten
earlier probes T1--T10 predate that file and are not indexed here. Series totals as recorded by the
diary at T125, the final part: \textbf{$125$ probes, $3139/3139$ sandbox checks}, plus
\vref{v535}--\vref{v541} promoted.
