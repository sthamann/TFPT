...
$123$ preregistered probes with $3077$ machine checks, which localized the residual object. That
...
% =====================================================================
\section{The certification arc (T102--T123)}\label{sec:certification}
% =====================================================================
The last twenty-two parts stopped improving measurements and started converting them into certificates ---
...
\noindent T124 (\texttt{multilevel\_telescope\_probe.py}, contract
\texttt{MULTILEVEL.TELESCOPE} --- the level telescope
$\varepsilon_\ell=\varepsilon_{\ell+1}+y_\ell^{\mathsf T}S_\ell y_\ell$, certified per-level
contributions without coarse inverses (a Levinson-bookkeeping candidate), the
self-similarity question, and a theorem candidate V8) was running at the time of writing and
is \emph{not} reported here.
...
obstruction. T124 (\texttt{multilevel\_telescope\_probe.py}) was running at the time of
writing.
...
% =====================================================================
\appendix
\section{Probe index, diary parts T11--T123}\label{app:index}
% =====================================================================
...
load-bearing artefact. The index covers the $113$ parts T11--T123 that the current diary file records
($114$ runs --- T104 was a double run with two independent arms --- and $2885$ green checks); the ten
earlier probes T1--T10 predate that file and are not indexed here. Series totals as recorded by the
diary at T123: \textbf{$123$ probes, $3077/3077$ sandbox checks}, plus \vref{v535}--\vref{v541}
promoted. T124
(\texttt{multilevel\_telescope\_probe.py}, contract \texttt{MULTILEVEL.TELESCOPE}) was still running
