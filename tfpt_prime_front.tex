...
$122$ preregistered probes with $3057$ machine checks, which localized the residual object. That
...
% =====================================================================
\section{The certification arc (T102--T122)}\label{sec:certification}
% =====================================================================
The last twenty-one parts stopped improving measurements and started converting them into certificates ---
...
about dips versus high-band mass, plus the CBS item.
\end{keybox}

\noindent T123 (\texttt{structural\_cbs\_probe.py}, contract \texttt{STRUCTURAL.CBS} --- a
structural bound for the coupling $\kappa_y$ by the same band machinery (the coupling needs
low-band mass, and $Wy$ has essentially none there), the band margin, the certified balance
against the ceiling, the $\varepsilon_f$ question, and a theorem candidate V7) was running at
the time of writing and is \emph{not} reported here.
...
margin $0.024$--$0.363\sim D^{-0.042}\alpha^{-0.525}$ (a fit); every scaling
...
constant, the Bank--Smith/D\"orfler--Nochetto saturation assumption (with
...
\textbf{[SUPPORT]} obstruction. T123 (\texttt{structural\_cbs\_probe.py}) was running at the
time of writing.
...
% =====================================================================
\appendix
\section{Probe index, diary parts T11--T122}\label{app:index}
% =====================================================================
...
load-bearing artefact. The index covers the $112$ parts T11--T122 that the current diary file records
($113$ runs --- T104 was a double run with two independent arms --- and $2865$ green checks); the ten
earlier probes T1--T10 predate that file and are not indexed here. Series totals as recorded by the
diary at T122: \textbf{$122$ probes, $3057/3057$ sandbox checks}, plus \vref{v535}--\vref{v541}
promoted. T123
(\texttt{structural\_cbs\_probe.py}, contract \texttt{STRUCTURAL.CBS}) was still running
