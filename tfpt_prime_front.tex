...
$121$ preregistered probes with $3037$ machine checks, which localized the residual object. That
...
$n=11\ldots121$). The probe file, the contract name, the verdict and the check count of every part are
...
% =====================================================================
\section{The certification arc (T102--T121)}\label{sec:certification}
% =====================================================================
The last eighteen parts stopped improving measurements and started converting them into certificates ---
...
\noindent T122 (\texttt{net\_balance\_repair\_probe.py}, contract \texttt{NET.BALANCE.REPAIR}
--- the Hankel repair (a replacement for link (5)), the structural Rayleigh step ($y$ is
high-band by construction), the reassembled net balance, and a theorem candidate V6) was
running at the time of writing and is \emph{not} reported here.
...
over $360$ rows ($\kappa_{\mathrm{end}}\ge0.4688$, $\delta\sim n_C^{+0.29}$); every scaling
...
Kac--Murdock--Szeg\H{o}/Widom/Fisher--Hartwig, Fej\'er--Riesz, the local Fourier / two-grid
...
(\texttt{net\_balance\_repair\_probe.py}) was running at the time of writing.
...
% =====================================================================
\appendix
\section{Probe index, diary parts T11--T121}\label{app:index}
% =====================================================================
...
load-bearing artefact. The index covers the $111$ parts T11--T121 that the current diary file records
($112$ runs --- T104 was a double run with two independent arms --- and $2845$ green checks); the ten
earlier probes T1--T10 predate that file and are not indexed here. Series totals as recorded by the
diary at T121: \textbf{$121$ probes, $3037/3037$ sandbox checks}, plus \vref{v535}--\vref{v541}
promoted. T122
(\texttt{net\_balance\_repair\_probe.py}, contract \texttt{NET.BALANCE.REPAIR}) was still running
