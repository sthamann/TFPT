"""v667 -- PRIME.BAEZDUARTE.01: THE BAEZ-DUARTE / NYMAN-BEURLING CONTROL
FRAME -- an EXTERNAL comparison Galerkin for the Suzuki route (W2/W3
control).
...
FIREWALL: the Riemann zeros ARE read here (mpmath zetazero, first
601, dps 15 -- same source and convention as v589_zero_comb.py) but
ONLY for the C_BD control constant of the EXTERNAL Baez-Duarte
frame; no zero enters any TFPT window/lock/Weil-form object; no
marker move; no RH statement.  Python-only, per GATE.WOLFRAM.02.

PROVENANCE: discovery probe baez_duarte_probe.py (2026-08-02, 12/12,
verdict BD-CONTROL-CLEAN); Vasyunin 1995 (biorthogonal system);
BDBLS Adv. Math. 149 (2000) (Notes 3) + Ramanujan J. 9 (2005)
(autocorrelation); Burnol Adv. Math. 170 (2002) (lower bound);
Bettin-Conrey arXiv:1111.0931 eq. (13) (the nu formula quoted
above); Baez-Duarte 2003 (natural dilations suffice); garding_probe
