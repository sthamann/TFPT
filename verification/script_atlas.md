...
- **v538_relative_trace_identity** [E/C/O] `HECKE.GEOM.RTF.01` — Tr_V(ν_p∘π) bilateral independent (geom=spec) at p=3,5,7×5 projectors; Eichler orbit dictionary λ_Eis+a_p²; period side = lattice count with R=23.1873585645… (18 checks, ~14 s)
  - deps: v535_hecke_from_geometry, v536_eichler_trace_layer, v537_halfintegral_bridge, v535, v536, v537, T53 · cited: 1 architecture e8, 3 e8 audit bootstrap, research contracts
- **v539_weil_structure_family** [E/C/O] `RTF.GNS.WEIL.01` — GNS fibre isolation (mix 5e-16); GL(1) core G₀=(1+Y)/(1−Y)=ζ_p(w−3)²/ζ_p(2w−6); Prime_F=2P_ζ−2P_ζ(g♭); TWO isolated obstructions (minus doubling; non-automorphic Corr); Q_fam≥0 on
  - deps: v538_relative_trace_identity, v538, T55, T61, T62, T63 · cited: 1 architecture e8, 3 e8 audit bootstrap, research contracts
- **v540_amplitude_linear_carrier** [E/C] `RTF.GNS.AMP.01` — Dirac D²=family kernel exact + Hecke-equivariant; polarisation b=N₊−N₋, Θ pure σ₃-eigenform with Cohen seed Θ(d)=−48·L(−1,χ_d); CL deletion universal = square-class double counting
...
- **v549_gauge_parity_identities** [E/O] `PRIME.GAUGE.PARITY.IDENT.01` — the identity/certificate core of T149+T150 recomputed on small frame-A windows (12 windows n=4…139, m=26…285 ≤ 300, D spanning 7.6e-03…2.8e-02; 48 gauge assemblies — Jacobi, const,
...
- **v552_angle_instruments** [E/O] `PRIME.ANGLE.INSTR.01` — min over v ⊥ W of vᵀL_Pv ≥ μᴾ₁₃ − λ_max(M^(1/2)(I − GGᵀ)M^(1/2)), an identity plus one certified Rayleigh bound valid for every m and every subspace — never exceeds the exact size-
  - deps: v551_ritz_ceiling_certificate, v550_odd_sector_identities, v551, T155, T157 · cited: 1 architecture e8, 3 e8 audit bootstrap, research contracts
- **v553_exact_form_identities** [E/O] `PRIME.EXACT.FORM.IDENT.01` — every trial an upper bound on the entry 1/s) plus the positive Cholesky ladder g_K from ONE Cholesky of the leading 16×16 block — all 16 terms strictly positive, partial sums monot
  - deps: v552_angle_instruments, v551_ritz_ceiling_certificate, v552, T158, T159 · cited: 1 architecture e8, 3 e8 audit bootstrap, research contracts
- **v554_sampling_harmonics_identities** [E/O] `PRIME.SAMPLING.HARM.01` — the closed theorem cores of T160+T161 recomputed on small frame-A windows (the 12 deepest in-cap zones n = 29…139, m = 96…291 ≤ 300 — v551…v553's declared surface — plus a declared
...
- **v557_cascade_vector_identities** [E/O] `PRIME.CASCADE.VECT.01` — the closed theorem cores of T166+T167 recomputed on small frame-A windows (the 12 deepest in-cap zones n = 29…139, m = 96…291 ≤ 300 — v551…v556's declared surface — with the one ar
...
- **v827_prime_zero_locator** [-] `PRIME.EXCLUSION.LOCATOR.01` — das Breitenprofil W(γ) = δ_mb(γ) des zertifizierten Turms PEAKT an wahren ζ-Ordinaten, und die präregistrierte v2-Regel besteht den Out-of-Sample-Test auf einem disjunkten unberühr
  - deps: v826_prime_exclusion_battery2, v825_prime_exclusion_ladder.py;v826_prime_exclusion_battery2.py;v827_prime_zero_locator.py;v828_prime_comb_window, v825, v826, v563, v755 · cited: 3 e8 audit bootstrap, research contracts
...
- **v833_gaussian_ramification_ladder** [E] `GAUSSIAN.RAMLADDER.01` — die vier dokumentierten Rollen des verzweigten Gaußschen Primelements π₂ = 1+i sind EIN maschinell geprüftes Objekt mit vier Sprossen, jede von Grund auf re-zertifiziert — **RAMIFI
  - deps: v689, v783, v798, v803, v819 · cited: 1 architecture e8, 3 e8 audit bootstrap
...
- **v841_relation_carrier_ladder** [O/X] `PRIME.RELATION.MULT.01` — die Ecken-Route ÖFFNET WIEDER mit der richtigen Input-Klasse (die multiplikativen Relationen zwischen Ereignissen) — **RELATION-CARRIER-EXISTS + EXCESS-NONNEGATIVE (18/18 + 13/13):
  - deps: v831_prime_alias_second_moment, v837_corner_closure_quantifier, v838_corner_expectation_position, v842_excess_certified_skeleton.py;v843_margin_law_excess_lean.py;v846_schur_spectral_mother.py;v847_wedge_cellcone_transport, v563, v738 · cited: 3 e8 audit bootstrap, research contracts
...
- **v880_finite_anchor_theorems** [E/C/O] `CFIN.QSTAR.NORMALFORM.01, DOILY.ANCHOR.CLASSIFY.01, DOILY.HODGE.FACTOR.01, P2.QUADRATIC.EXHAUSTION.01` — die geschlossene, zensus-freie Normalform q*(x) = Σ_{i<j}x_ix_j + Σx_i = C(|x|+1,2) mod 2 (gewichts-rein; Selektor auf dem Linearteil erzwungen); die EXKLUSIVE Anker-Klassifikation
  - deps: v845_cfin_normal_form, v845, v774, v880_finite_anchor_theorems, v844_message_doily_rank, v832, v844, v857 · cited: 1 architecture e8, 3 e8 audit bootstrap, research contracts
- **v881_carleson_port_geometry** [E/O/X] `PRIME.CD.PICKDEFECT.01, PRIME.CARLESON.TESTING.01, PRIME.PORT.SCHUR.01, PRIME.PORT.INTEGRABLE.01, PRIME.PORT.LIMIT.01, PRIME.PORT.SCALAR.01, PRIME.PORT.COCYCLE.01, PRIME.PORT.RIEMANNHILBERT.01, PRIME.ERRORTERM.SCALE.01` — vier Seiten EINES Objekts (11/11 + 5/5 + 8/8 + 5/5)** — das wörtliche Rang-2-Pick-Ziel WIDERLEGT und ersetzt: exakte Rang-2-Jacobi-Verschiebung (4.3e-14, source-only, Holdouts); Ga
...
- **v887_certified_ladder_complete** [E] `PRIME.PORT.CERTIFIED.LADDER.01` — σ_h > 0 ist jetzt auf ALLEN 42 erreichbaren Sprossen BEWIESEN: dieses Modul schließt die letzten zwei Sprossen h = 859/878 (validated-precision mpmath-Cholesky dps 120/200 mit Präz
  - deps: v884_certified_head_positivity, v563, v866, v884 · cited: 3 e8 audit bootstrap, research contracts
- **v888_finite_pfaffian_signature** [E/C/O/X] `DOILY.PLUCKER.GR25.01, CFIN.AUT.FLAVOR.C6.01, DOILY.PFAFFIAN.WICK.01` — Specht-Kanäle (1, 0, 2/3) exakt; die 15 Doily-Linien SIND die 15 Plücker-Monome von Gr(2,5) mit perfektem Vorzeichen-Match; (16,6,2,10)-Hadamard-Anker; S₆→S₅-Vakuumselektion (Orbit
  - deps: v880_finite_anchor_theorems, v880, v845, v844, v849, v808, v857, v888_finite_pfaffian_signature · cited: 1 architecture e8, 3 e8 audit bootstrap, research contracts
...
- **v892_closure_architecture** [E/C/O/X] `PRIME.PORT.RELCONG.01, PRIME.PORT.PIVOTFACTOR.01, PRIME.PORT.EULER.ROUCHE.01, PRIME.PORT.DEEPCORE.SCHUR.01` — die exakte hermitesche Kongruenz A₊ = A^{1/2}(I+H)A^{1/2} (6.5e-14) mit NICHT-ZERFALLENDER Vererbungsmarge η (min 0.0050, Slope +0.108 vs τ −2.74; ρ war irreführend — nicht-normal;
  - deps: v895_collective_comb, v890_total_positivity_flow, v563, v890, v892_closure_architecture, v881_carleson_port_geometry · cited: 3 e8 audit bootstrap, research contracts
- **v893_relative_margins** [E/O] `PRIME.PORT.ETASOURCE.01, PRIME.PORT.RELFLAG.01` — SCALE-MATCHED: Inkrement und Operator kollabieren in der gefährlichen Richtung GEMEINSAM (Slopes −3.716/−3.456, Residuen-corr 0.974, 94% geteilte Varianz) — η ist skalenfrei, weil
  - deps: v892_closure_architecture, v563 · cited: 3 e8 audit bootstrap, research contracts
- **v894_diagonal_refinement** [C/O] `PRIME.CASE.PAIRCORR.CONTRACT.01` — der exakte Prim-Kern K_{h,m} (Regruppierung 4.5e-15, BAND-LIMITIERT: n90 = 7-26 Moden — einseitige Explizite-Formel-Positivität an den Port-Frequenzen; LaTeX-Statement eingefroren;
  - deps: v889_route_decisions, v882_port_source_mellin, v563, v889 · cited: 3 e8 audit bootstrap, research contracts
- **v895_collective_comb** [E/X] `PRIME.PORT.FACTORAVOID.01, PRIME.PORT.DEEPCORE.01` — die Norm-Schranken-Satzform existiert NICHT (ρ ≥ 1 auf 17/31, immer über die harmlose Seite); das echte Gesetz ist EINSEITIG (max(−min μ) = 0.9950 < 1 auf allen 31 Schritten = PD-V
  - deps: v890_total_positivity_flow, v563, v890, v891_moebius_firewall_kills, v883_tau_chain_parametrix, v891 · cited: 3 e8 audit bootstrap, research contracts
- **v896_wick_block_functor** [C/O] `SEAM.CFIN.WICKFUNCTOR.01` — die sechs Rollen existieren im deployten Seam (D5-Slot-Paare + A3-Randblock; so(16)-Sektorgesetz, q*-Grading, C₆-Intertwining exakt), aber der Vakuum-Kernel ist kanal-diagonal; die
  - deps: v888_finite_pfaffian_signature, v880_finite_anchor_theorems, v888, v113 · cited: 1 architecture e8, 3 e8 audit bootstrap, research contracts
- **v897_certified_interval_ladder** [E] `PRIME.PORT.BALLLADDER.01` — das informelle ε_c-Fehlermodell ist von der Leiter PENSIONIERT: σ_h > 0 mit RIGOROSEN mpmath.iv-Intervall-Shifts auf ALLEN 42 erreichbaren Sprossen h = 142–878 (15 exakt-rationale
  - deps: v887_certified_ladder_complete, v884_certified_head_positivity, v563, v866, v884, v887 · cited: 3 e8 audit bootstrap, research contracts
- **v898_kms_schur_mixing** [E/O] `SEAM.CFIN.KMSMIX.01` — der C₆-kovariante mischende KMS-Zustand EXISTIERT (u = 1, t = 1/8, β = 1: alle 15 Kreuzblöcke am Floor, Grading 5/5 + 10/10, alle 15 Wick-Monome mit kanonischen Pf4-Vorzeichen; β =
  - deps: v896_wick_block_functor, v888, v113, v426, v440 · cited: 1 architecture e8, 3 e8 audit bootstrap, research contracts
- **v899_christoffel_normsquare** [E/C/X] `PRIME.PORT.CHRISTOFFEL.RATIO.01, PRIME.CASE.KERNEL.SOS.01, PRIME.CASE.EDGEDEFECT.01` — die EXAKTE Identität 1/d₁₂ = 1 + v⋆·K_σ(y⋆) (deflationierte Christoffel-Form, unabhängige Route 2e-11; ehrliche Fence: λ_min(I−G) = τ exakt — Koordinatenwechsel, keine unabhängige
  - deps: v893_relative_margins, v892_closure_architecture, v563, v893, v894_diagonal_refinement, v894, v899_christoffel_normsquare · cited: 3 e8 audit bootstrap, research contracts
- **v900_core_update_anatomy** [E/O] `PRIME.PORT.NORMALIZED.CORE.01, PRIME.PORT.GRAPH.REGION.01` — das EXAKTE Update X′ = c(X + U) bei 8.3e-16 mit effektiv ZWEIDIMENSIONALEM Input (c = τ/τ′ + EIN Matrix-Modus mit 97.5% Energie); die ehrlichen Negative als Randbedingungen registr
  - deps: v892_closure_architecture, v893_relative_margins, v563, v892, v893, v900_core_update_anatomy · cited: 3 e8 audit bootstrap, research contracts
- **v901_tangent_schur_bfloor** [E] `PRIME.PORT.TANGENT.SCHUR.01, PRIME.PORT.BFLOOR.01, PRIME.PORT.SIGNFREE.NORMALIZATION.01` — der EXAKTE quellseitige Split: mit B PD ist die Wand PD ⟺ n − q > 0 (zwei Skalare n = vᵀMv, q = bᵀB⁻¹b; alle Identitäten gewardet, PD-Äquivalenz boolesch exakt 39/39, kein tau', ke
  - deps: v900_core_update_anatomy, v892_closure_architecture, v563, v900, v901_tangent_schur_bfloor, v897 · cited: 3 e8 audit bootstrap
- **v902_wall_relocation_map** [E] `PRIME.CASE.EDGE.CHRISTOFFEL.01, PRIME.PORT.GRAM.COMPLETION.01, PRIME.PORT.RADAU.WEIGHT.01` — explizit als Mechanismus-Karte getypt, KEIN Fortschritt** — die exakte Positive-Gewichte-Umschreibung 1/d₁₂ = 1 + Σ W Q² − β (W > 0 exakt bei 9.7e-14 ohne Toleranz, jeder β-Term ≥
  - deps: v899_christoffel_normsquare, v563, v899, v902_wall_relocation_map · cited: 3 e8 audit bootstrap
- **v903_seam_rp_exclusion** [E] `SEAM.STATE.DERIVATION.01, SEAM.CFIN.MIXING.NORMALIZATION.01, SEAM.CFIN.MINIMAL.MEDIATOR.01, SEAM.CFIN.TWISTED.RP.01, SEAM.CFIN.RP.DILATION.01, SEAM.CFIN.GAP.PENCIL.01` — strikte RP erzwingt t = 0 unter BEIDEN räumlichen Reflexionen (odd-Gram-Eigenwerte EXAKT ±|a_J| der {4,5}-Duade auf 2.2e-16: OS-Positivität ⟺ a_J = 0 ⟺ der v898-Mischungs-Floor FÄL
...
- **v935_thetainf_landau_bridge** [E/O] `PRIME.THETAINF.PIN.01` — der klassische Pin von θ_inf landet NICHT und die Runde beweist exakt warum, mit der ERSTEN LINEAREN PER-MODEN-KLASSISCHEN IDENTITÄT des Programms: der Primblock der Weltmatrix ist
  - deps: PRIME.GONEK.PRICING.01 (v934: the unconditional Landau/Gonek machinery the bridge consumes), PRIME.H3.COFINAL.01 (v933: the theta_inf band + the DK instrument), PRIME.TOPROOT.THETA.01 (v932: the H3 statement + record ladders), round 175 note CDXCI (the frozen probe), Bughunt VII round 176 note CDXCII (F1 + F2 + F7 applied here) · cited: 3 e8 audit bootstrap, research contracts
- **v936_manifold_invariance_exclusion** [E/C] `PRIME.MANIFOLD.INVARIANCE.01` — der BH7-F4-Scope-Gap innerhalb des Instruments beseitigt: der Ausschluss ist (i) ein tau-freier RICHTUNGS-UNIVERSALSATZ für h ≤ 13 an der gefrorenen 1e-25-Bar (gemessen bis h = 20)
  - deps: PRIME.H3.COFINAL.01 (v933: the DK instrument + BH7-F4 scoping this round removes), PRIME.TOPROOT.THETA.01 (v932: H3), PRIME.FULLGAP.GROWTHLAW.THEOREMS.01 (v926: the quartic cap consumed ONLY as FLAGGED-MEASURED), round 177 note CDXCV (the frozen probe), Bughunt VIII round 183 note DI (F7 applied here) · cited: 3 e8 audit bootstrap, research contracts
...
- **v939_cbj_frame_adjudication** [E/X] `PRIME.CBJ.CONFLUENT.FRAME.01` — die extern vorgeschlagene Review-Primärroute (COFINAL-BLOCK-JET via konfluentem Jet-Frame) vollständig instrumentiert: Schritte A/B/D landen EXAKT bzw. quellrein — SCHRITT A (δ_h =
  - deps: PRIME.SIGMAFLOOR.FACTORIZATION.01 (v929: SF1/SF2/SF6 wiring), PRIME.WINDOW.INSTRUMENT.MECHANISM.01 (v930: the entry atoms the selector upgrades), PRIME.MOMENT.LAURENT.ROOTLADDER.01 (v924: L1) + v922 (the spacing product re-derived), round 180 note CDXCVII (the frozen probe), PRIME.CBJ.SUBDOF.BLOCKFLOOR.01 (v940: the sub-dof scoping downstream), Bughunt VIII round 183 note DI (dof/MV/Bertrand verified here) · cited: 3 e8 audit bootstrap, research contracts
...
- **v972_seam_interaction_front** [E/X] `SEAM.INT.ODDSPLIT.01, SEAM.INT.OSAVOID.01` — (1) Die hinreichende Jaffe–Pedrocchi-Bedingung für Majorana-Reflexionspositivität (arXiv:1406.1384; Wei–Li–Xiang arXiv:1601.01994) wird auf dem v529-FK-Toy ENTSCHEIDBAR gemacht: di
  - deps: v529_seam_interacting_toy_fk, v519_woit_theta_rp_free, v529, v903, v972_seam_interaction_front · cited: introduction, 3 e8 audit bootstrap, 5 redteam, research contracts
...
- **v286_seam_equivalence_contract** [E/C/O] `SEAM.EQUIV.01` — the Seam Equivalence contract: concentrates the whole open structure on ONE named arrow (does NOT prove it). Theorem: the raw RP seam state reconstructs canonically the holomorphic
  - deps: v181_clock_is_conformal_symmetry, v279_qgeo_obligation_lemma, v282_e8_tau_i_unification, v284_route_i_rp_uniqueness, v285_route_ii_seam_condensation, v366_mmst_seam_collar.py; v994_mmst_criteria_battery.py; v998_seam_modular_closure, v492_celestial_z4_orbifold · cited: research contracts
...
- **v384_residual_certification** [E/O] `RESIDUAL.CERTIFICATION.01` — RESIDUAL.CERTIFICATION.01 (historical compiler scope; corrected 2026-09-05): the then-listed compiler residual is CERTIFICATION, not CONSTRUCTION -- after v369/v381/v382 there is N
  - deps: v286_seam_equivalence_contract, v382_alpha_quillen_exact.py; v985_quillen_channel_swap.py; v995_kms_subnet_rigidity.py; v996_gauge_grammar_kill.py; v1014_bridge_refinements, QG.AMB.01, v78_vgeo_floor, v371_ftransfer_pole, v1012_toe_gate_witnesses.py; v1013_thermodynamic_dynamics.py; v1014_bridge_refinements.py; v1015_axiom_core_closure.py; v1022_telb_round3_certificates.py; v1023_derivative_filtered_wall.py; v1024_parent_internal_boundaries.py; v1025_telb_c1_c2a_certificates.py; v1026_telb_round4_closure.py; v1027_signed_det_car_wall.py; v1028_gauss_d4_cap.py; v1029_local_tensor_constraints.py; v1030_alg2_sector_frame, v153, v336 · cited: research contracts, safeguards
...
- **v976_seam_lift_birkhoff** [E/C/O] `TRANSFER.HIDDEN.CIRCULATION.01` — B = (1/2)I + (1/18)P12 + (2/9)P13 + (2/9)P23 bit-exakt (B^6 = v221-Kernel), Kern der Zerlegungsabbildung 1-dim (I + C123 + C132 = P12 + P13 + P23 = J), vollstaendige Familie w_t mi
  - deps: v984_markov_qca_dilation.py; v987_os_dilation_package.py; v999_weak_collision_hp, v971_markov_embedding_generator, v221_seam_qecc, v221_seam_qecc, v652_orbifold_arf · cited: origin theory, research contracts
- **v977_transfer_unistochastic_wilson** [E/C/O] `TRANSFER.COHERENT.WILSON.01` — exakter SU(3)-Lift mit dem Wilson-Code 5-12-13, der Center-Bruecke und einem klassisch unsichtbaren Orientierungsbit** — Winkel von B erzwungen (sin^2 th13 = 2/9, sin^2 th12 = 1/14
  - deps: v976_seam_lift_birkhoff, v984_markov_qca_dilation.py; v987_os_dilation_package.py; v999_weak_collision_hp, v530_center_quotient_compiler, v738_hecke_mod_ramified, v270_pmns_jarlskog_assembly · cited: origin theory, 2 standard model, research contracts
- **v983_simple_current_generator** [-] `(no ledger claim)` — exakt auf Gitterebene** — |omega_s|^2 = 5/4, |omega_f|^2 = 3/4, |lambda|^2 = 2, konformes Gewicht h_lambda = 1 (ganzzahlig => triviale Selbstmonodromie); [lambda] hat ORDNUNG VIER
  - cited: research contracts
- **v984_markov_qca_dilation** [-] `(no ledger claim)` — B^n als reduzierte Dynamik eines exakt unitaeren, strikt lokalen QCA-Bandes** — der Kollisionsschritt V = C (U_B (x) I) mit dem mod-3-Rekord C|j,k> = |j, j+k> ist unitaer auf Syste
  - cited: origin theory, research contracts
- **v985_quillen_channel_swap** [-] `(no ledger claim)` — das Jump-Muster circ(2,-1,0,-1) hat mu4-Eigenwerte [0, 2, 4, 2] (Kernel k = 0), das Mark-Muster circ(0,1,2,1) hat [4, -2, 0, -2] (Kernel k = 2) — der v974-Befund symbolisch; der DE
  - cited: origin theory, 1 architecture e8, research contracts, safeguards
- **v986_nu_scalaron_rung** [-] `(no ledger claim)` — ein strukturierter Punkt IM v481-Fenster, 1.8 % von der 1-Loop-Anforderung** — 3 M_scal = 9.180e13 GeV vs das v481-geforderte 9.346e13 GeV (dieselbe eingefrorene 1-Loop-Inversion,
  - cited: 2 standard model, 4 frontier
- **v987_os_dilation_package** [-] `(no ledger claim)` — DYN.UNITARY.DILATION.01 [O-Update: OS/Dilatation-Leiter ausgefuehrt] (Promote-Runde 2026-08-28): **Kernel-OS-Fortsetzung exakt + groessen-uniformes freies Band + Kongruenz-Familie
  - cited: research contracts
...
- **v994_mmst_criteria_battery** [-] `(no ledger claim)` — SEAM.EQUIV.MMST.01 / SEAM.SIMPLECURRENT.GENERATOR.01 [O-Update: 5/7 MMST-Identifikationskriterien ausgefuehrt [E-gemessen]; C6 ausgeschrieben [C]; C7 zitiert/offen] (Vollstaendigke
  - cited: introduction, 4 frontier, research contracts
- **v995_kms_subnet_rigidity** [-] `(no ledger claim)` — SEAM.STATE.RPMIXING.01 [E-Update: endliche KMS-Rigiditaet] + ALPHA.QUILLEN.EXACT.01 [O-Notiz: Rigiditaets-Praemisse endlich] (Vollstaendigkeits-Welle 2026-08-28): ALLE 33 v972-Misc
  - cited: introduction, 4 frontier, research contracts
- **v996_gauge_grammar_kill** [-] `(no ledger claim)` — GAUGE.DETLINE.FIXPOINT.01 [O-Update: naive Grammatik-Erweiterung ausgeschlossen [E]; echt nichtabelsche Struktur noetig -- typisiert] + ALPHA.QUILLEN.EXACT.01 [O-Notiz: ln-2-Rate-S
  - cited: introduction, 4 frontier, research contracts
- **v997_spin2_smg_witnesses** [-] `(no ledger claim)` — GRAV.SPIN2.EMERGENCE.01 [O-Update: quadratische Zeugen [E]; Inhalt auf untrunkierter Formfunktion gepinnt] + CHIRAL4D.NOMIRROR.01 [O-Update: SMG-Mechanismus toy-bewiesen [E]; 4D-Sp
  - cited: introduction, 4 frontier, research contracts
- **v998_seam_modular_closure** [-] `(no ledger claim)` — SEAM.EQUIV.MMST.01 / SEAM.SIMPLECURRENT.GENERATOR.01 [O-Update: C7-ARITHMETIK-SCHATTEN jetzt exakt; Netz-C7 bleibt zitiert] (Review-Welle 4, 2026-08-29): Zwei-Kanten-HS-Rest <= 2.1
  - cited: introduction, 4 frontier, research contracts
- **v999_weak_collision_hp** [-] `(no ledger claim)` — DYN.UNITARY.DILATION.01 [O-Update: endliche Leiter jetzt VOLLSTAENDIG -- diskret/Kernel/feld-frei/wechselwirkend-klassisch/quantum-gekoppelt/KONTINUIERLICHE ZEIT; offen = thermodyn
  - cited: introduction, 4 frontier, research contracts
- **v1000_spin2_sk_witnesses** [-] `(no ledger claim)` — GRAV.SPIN2.EMERGENCE.01 [O-Update: quadratische Hamilton-Haelfte ausgefuehrt] + FTRANSFER.SK.RHO0.01 [O-Update: SK-Mechanismus ausgefuehrt] (Review-Welle 4, 2026-08-29): Gitter-Gra
  - cited: introduction, 4 frontier, research contracts
- **v1001_nu_pentagon_chain** [-] `(no ledger claim)` — FLAV.NUSCALE.06 Kandidat [C]/[N] (Review-Welle 4, 2026-08-29; KEIN Schluss; Mechanismus = Q_+-zu-Flavor-Operator [O]): U_e=I Inventar + analytische 13/23-Fehlausrichtung; Pentagon-
  - cited: introduction, 2 standard model, 4 frontier, research contracts
- **v1002_spin10_mirror_projector** [-] `(no ledger claim)` — CHIRAL4D.MIRROR.DET16.01 Kandidat [C] (Review-Welle 5, 2026-08-29; genaues endliches-Cluster-Gapping; offen: dynamische Eichfelder, Domain-Wall-Geometrie, 4D-Volumentheorem): DET16
  - cited: 4 frontier, research contracts
- **v1003_nu_structural_nulls** [-] `(no ledger claim)` — FLAV.NU.TEXTURE.MECHANISM.01 [O] (Review-Welle 5, 2026-08-29; bindende Constraints, keine Texture): [E] geladener Sektor h=(1,1,1), d=(64,60,64); [X] Schur-Texture-NULL 8/8 (K,B) s
  - cited: 2 standard model, 4 frontier, research contracts
- **v1004_milnor_frobenius_gray** [-] `(no ledger claim)` — SEAM.MILNOR.LOCALRING.01 [O] (Review-Welle 6, 2026-08-30; endliche Algebra; Korpus-Identifikation bleibt offen): KLASSISCH (zitiert, kein Claim) Milnor-Algebra von x^2+y^3+z^5 cong
  - cited: introduction, 4 frontier, research contracts
- **v1005_relative_pencil_bridges** [-] `(no ledger claim)` — Relative-Pencil-Bruecken (Review-Welle 6, 2026-08-30; Zirkularitaets-Flag): EXAKT [E-finite] Hankel p_n p_{n+2}-p_{n+1}^2=2^{n+1} + Jacobi-Spec {1,2} Diag (4/3,5/3) (v106/v119); Wi
  - cited: introduction, 4 frontier, research contracts
- **v1006_mmst_lemma_battery** [-] `(no ledger claim)` — SEAM.MMST.TYPEIII.CHARGED.01 [O]: five in-house lemmas; Round-4 document guard requires native v1026 norm below 2.995906 at fixed M=1, Ny=8 for all even N>=16 plus explicitly open
  - cited: introduction, 4 frontier, research contracts
...
- **v1008_master_assembly_scaffold** [-] `(no ledger claim)` — QFT4D.LATTICE.FUNDAMENTAL.01 Decision / GAUGE.DETLINE.FIXPOINT.01 [O] (Review-Welle 7, 2026-08-30; 2+1D-Scaffold kohaerent): Prototyp K=0 Plaquette-Exponenten; Materie frozen-link
  - cited: introduction, 4 frontier, research contracts
- **v1009_rho0_minimizer** [-] `(no ledger claim)` — FTRANSFER.SK.RHO0.01 [O] (Review-Welle 7, 2026-08-30): [E-finite] eindeutige KMS-Kompression (Klein), Hesse strikt positiv, Zentrum dim 1, Identitaet ~8e-17. [X] V1000_CONSEQUENCE_
  - cited: introduction, 4 frontier, research contracts
- **v1010_simplicity_bridge_census** [-] `(no ledger claim)` — Simplicity-Zensus + W/Q-Kanonizitaet + Milnor-Doppelobstruktion (Nachmittag 2026-08-30): Ableitungsmatrix; Restminimum S4=2; Anker (1,1,2) nicht unter 3 deklarierten Milnor-Karten;
  - cited: introduction, 4 frontier, research contracts
...
- **v1022_telb_round3_certificates** [E/C/O/X] `SEAM.MMST.TELB.ROUND3.01` — TEL-B-Runde-3-Zertifikate (2026-09-05): natives Arb/Acb, 256 Bit, 5812 rationale Zellen; TV_p(F'') <=15.817695962988924...<15.928674 und K3_TV<2.517464500835. Die analytische C2b-S
  - deps: v1025_telb_c1_c2a_certificates, v1006_mmst_lemma_battery.py; v1016_state_gap_batteries.py; v1022_telb_round3_certificates.py; v1025_telb_c1_c2a_certificates, v1012_toe_gate_witnesses.py; v1013_thermodynamic_dynamics.py; v1014_bridge_refinements.py; v1015_axiom_core_closure.py; v1022_telb_round3_certificates.py; v1023_derivative_filtered_wall.py; v1024_parent_internal_boundaries.py; v1025_telb_c1_c2a_certificates.py; v1026_telb_round4_closure.py; v1027_signed_det_car_wall.py; v1028_gauss_d4_cap.py; v1029_local_tensor_constraints.py; v1030_alg2_sector_frame · cited: research contracts
...
- **v1024_parent_internal_boundaries** [E/C/O] `FLAV.NU.PARENT.INTERTWINER.01, GRAV.PARENT.GAP.NO_GO.01, FTRANSFER.PARENT.Z5CAP.01` — Parent-interne T6--T8-Grenzen (2026-09-05): endlicher A3--D4 Seam/Neutrinopaar-Intertwiner ohne neuen Faktor; positiv, gerade, gauge-kompatibel, nichtadditiv, lokaler Gap 0.25 kond
  - deps: v1003_nu_structural_nulls.py; v1012_toe_gate_witnesses.py; v1024_parent_internal_boundaries, v1012_toe_gate_witnesses.py; v1013_thermodynamic_dynamics.py; v1014_bridge_refinements.py; v1015_axiom_core_closure.py; v1022_telb_round3_certificates.py; v1023_derivative_filtered_wall.py; v1024_parent_internal_boundaries.py; v1025_telb_c1_c2a_certificates.py; v1026_telb_round4_closure.py; v1027_signed_det_car_wall.py; v1028_gauss_d4_cap.py; v1029_local_tensor_constraints.py; v1030_alg2_sector_frame, v997_spin2_smg_witnesses.py; v1000_spin2_sk_witnesses.py; v1012_toe_gate_witnesses.py; v1024_parent_internal_boundaries, GRAV.WEINBERG.WITTEN.01, v1000_spin2_sk_witnesses.py; v1009_rho0_minimizer.py; v1012_toe_gate_witnesses.py; v1016_state_gap_batteries.py; v1024_parent_internal_boundaries, v1020_spectator_sector_obstruction · cited: 2 standard model, research contracts
...
- **v1026_telb_round4_closure** [E/O] `SEAM.MMST.TELB.NORM.01` — Native interval TEL-B norm below 2.995906 at fixed M=1, Ny=8 for all even N>=16; CF/DG/CROSS and validated Fourier aliases; ALG-EXH/MMST open
  - deps: v1022_telb_round3_certificates, v1025_telb_c1_c2a_certificates · cited: introduction, origin theory, 4 frontier, research contracts
- **v1027_signed_det_car_wall** [E/C/O] `CHIRAL4D.MIRROR.SIGNED.CAR.01` — Exact canonical DET modes and signed z=1 wall for fixed classical gauge fields; no hard bare-mirror gap or chiral continuum
  - deps: v1023_derivative_filtered_wall, v1002_spin10_mirror_projector.py; v1007_det16_stability_battery.py; v1016_state_gap_batteries.py; v1023_derivative_filtered_wall · cited: introduction, 4 frontier
- **v1028_gauss_d4_cap** [E/C/O] `PARENT.GAUSS.D4.ROUND4.01` — Gauss residues with full 192-mode site characters and specified nine-irrep cube links; symmetric selected-pair-space D4 cap; no canonical clock family, mass texture or global state
  - deps: v1003_nu_structural_nulls.py; v1012_toe_gate_witnesses.py; v1024_parent_internal_boundaries, v1000_spin2_sk_witnesses.py; v1009_rho0_minimizer.py; v1012_toe_gate_witnesses.py; v1016_state_gap_batteries.py; v1024_parent_internal_boundaries · cited: introduction, 4 frontier
- **v1029_local_tensor_constraints** [E/C/O] `GRAV.SPIN2.LOCAL.CONSTRAINT.01` — Local tensor constraints give two z=1 radiative modes after explicit global zero-mode removal; no TFPT embedding
...
**Most-depended-on claims** (the load-bearing roots): `v563`×210, `SEAM.EQUIV.01`×93, `v336`×37, `QGEO.SYM.01`×34, `v216`×28, `CELEST.SEAM.01`×25, `v752`×25, `v755`×25, `AX.P2.01`×22, `v738`×21, `QG.AMB.01`×19, `v76`×19, `v56`×19, `v492`×19, `v367`×18
...
- **v1027_signed_det_car_wall** — `CHIRAL4D.MIRROR.SIGNED.CAR.01`
