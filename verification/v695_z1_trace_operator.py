"""v695 -- PRIME.Z1MEASURE.01: THE Z1 SEARCH -- OFFENSIVE 5 (contract
PRIME.Z1.OPERATOR.01):
...
FIREWALL: v563 import read-only (the hecke_sos / v691 pattern); NO
zero of any L-function is read anywhere; NO
...
PROVENANCE: discovery probe z1_trace_operator_probe.py (2026-08-03,
25/25 PASS, verdict Z1-MEASURE-FROM-COUNTING-OPERATOR-OPEN: seam +
orbifold dead as Z1 spectrum (null-calibrated); the E8 counting route
delivers the Weil measure exactly -- atoms 0.0e+00, arch/pole via
Gamma duplication, 7/8 target spikes, q = 0.000; comb + pole is
positive-feasible, signedness = pole subtraction);
hecke_sos_probe / v691 (offensive 4: index lemma, Ihara scaffold,
