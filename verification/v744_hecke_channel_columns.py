"""v744 -- PRIME.CHANNELSOS.01: channel columns for the Hecke SOS -- no canonical column choice factorizes, and the Ihara channel route fails coherently (HECKE-SOS-CHANNELS-PARTIAL).

PROVENANCE: discovery probe hecke_channel_columns_probe.py (2026-08-04, 15 checks / 0 failures, verdict HECKE-SOS-CHANNELS-PARTIAL).  Promoted verbatim; numbers unchanged.
