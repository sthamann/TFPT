#!/usr/bin/env python3
"""v614 -- QGEO.TRANSPORT.01: the Gauss-Manin transport round -- the deck
step IS the boundary monodromy, and the v613 dictionary is canonical.

Round 17 of the QGEO cover program (after v613); closes v613's named
residue F1 at the transport level.
...
PROVENANCE: discovery probe transport_deck_probe.py (2026-08-01, 12/12,
