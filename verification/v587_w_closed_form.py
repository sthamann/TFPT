"""v587 -- PRIME.WCLOSED.01: the diagonal companion of the v576 cross formula,
...
PROVENANCE: discovery probe w_closed_form_probe.py (2026-08-01, 6/6,
CLOSED-FORM-EXACT); v563 constructor read-only.
...
def run():
    ...
    print("--- PRIME.WCLOSED.01 exact diagonal weight formula: %d passed, %d failed ---"
