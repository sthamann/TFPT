"""Regression tests for v1016's Round-4 memorandum guard."""
...
import v1016_state_gap_batteries as audit
...
class Round4DocumentGuardTests(unittest.TestCase):
    ...
    def test_historical_increment_formulation_alone_is_rejected(self) -> None:
        stale = (
            r"\le\frac{A_R}{N} A_R<48(3-R_{96}^{+})\simeq42.956 "
            "0.120 0.123 TAIL-TELESCOPING-FAILS ALG-EXH"
        )
