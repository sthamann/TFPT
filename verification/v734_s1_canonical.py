#!/usr/bin/env python3
"""v734 -- PRIME.S1CANON.01: S1-SCHEIBE -- das kanonische System
des Limes-Objekts mit dem
...
PROVENANCE: discovery probe s1_canonical_probe.py (2026-08-03, 10/10
PASS, verdict S1-CANONICAL-SUZUKI-BRIDGED: Krein correspondence exact
-- Weyl identity max rel dev 1.6e-15 over 4 complex z x 9 windows,
nilpotency residual 3.1e-16; H_h >= 0 MEASURED on all 9 windows
(min l_k = 0.033 .. 0.377, all > 0); gauge-invariant Weyl disks Cauchy
with rate; boundary phase == gamma side with scale EXACTLY 1 (dev
1.9e-2 .. 2.5e-2 at tau0 = 15/25/40); scramble breaks the
Wheeler/Krein chain at depth 31 -- H >= 0 is arithmetic substance.
The wall in the FOURTH language: Suzuki's GRH criterion (JFA 281
(2021) 109116) as a finite witness per truncation.  Promoted verbatim
(sibling imports now point at v696/v716/v718); numbers unchanged.
"""
