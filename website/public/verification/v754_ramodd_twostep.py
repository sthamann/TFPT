#!/usr/bin/env python3
"""v754 -- PRIME.HECKETWOSTEP.01: the real n -> 4n down-up pass IS exactly K^2 -- degree factor 196 = (2*7)^2 closed, KMS half-weight exponent-exact, identical integer matrix on all 9 contexts, T = 4 B^2, Perron-Frobenius cone-preserving (TWOSTEP-EXACT).

PROVENANCE: discovery probe ramodd_twostep_probe.py (2026-08-04, 19/19 checks, verdict TWOSTEP-EXACT).  Promoted verbatim (sibling import points at the promoted v738 module; run() aliases main()); numbers unchanged.
