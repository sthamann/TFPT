"""v700 -- E8.ORBIT60.01: ORBIT60 CENSUS -- the 60 mu4-lines of E8 as
a combinatorial object: quotient graph, sigma / clock / Coxeter
dynamics on the ORBIT SPACE, and a STRICT park test for the cascade
...
FIREWALL: no marker moves; the involution census is a census over
GROUP elements (canonical objects), not a search over arbitrary
pairings; deterministic (fixed seed for the small-generating-set
search only).

PROVENANCE: discovery probe orbit60_census_probe.py (2026-08-03,
18/18 PASS, verdict ORBIT60-PARKED: all canonical cascade routes
dead, no involution witness in the line group (order 11520),
W(E8) Coxeter does not descend, no A5 signature -- parked per the
review protocol);
root_incidence_probe.py / v629 (J free, 60 = D_start),
