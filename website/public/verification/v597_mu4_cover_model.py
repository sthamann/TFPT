"""v597 -- QGEO.COVER.01: Strategy I/II, first executed step: the mu3-cover of
...
PROVENANCE: discovery probe mu4_cover_model_probe.py (2026-08-01, 6/6,
FINGERPRINTS-HIT); exact sympy throughout.
...
def run():
    ...
    print("--- QGEO.COVER.01 mu3-cover fingerprints: %d passed, %d failed ---"
