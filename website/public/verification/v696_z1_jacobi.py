#!/usr/bin/env python3
"""v696 -- PRIME.Z1JACOBI.01: OFFENSIVE 5b -- Z1 canonical
construction: Verblunsky / CMV / Jacobi from the positive comb
sequence (c + pole).

PROVENANCE: discovery probe z1_jacobi_probe.py (2026-08-03, 18/18
PASS, verdict Z1-JACOBI-OPAQUE with the strong renaming clause
explicitly NOT confirmed: canonical CMV/Jacobi operator exists
(moments 2e-13), no closed law, BUT features on prime-power slots
(q = 0.000), amplitude-mass link r_log = +0.76, positivity collapses
without the true masses (170/171 vs 2865); Ihara anchor: Kesten-McKay
exact, girth corrections).
