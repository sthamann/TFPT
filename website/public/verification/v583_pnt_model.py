"""v583 -- PRIME.PNTMODEL.01: the named next step of v582, executed: the smooth
...
PROVENANCE: discovery probe pnt_model_probe.py (2026-07-31, 8/8,
PRIME-FREE-CLOSED-FORM); v563 pipeline read-only.
...
def run():
    ...
    print("--- PRIME.PNTMODEL.01 prime-free closed form: %d passed, %d failed ---"
