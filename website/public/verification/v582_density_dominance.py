"""v582 -- PRIME.DENSITYDOM.01: the quantitative occupation question, answered at
...
PROVENANCE: discovery probe density_dominance_probe.py (2026-07-31,
5/5, DENSITY-DRIVEN); construction base v563/v580 read-only.
...
def run():
    ...
    print("--- PRIME.DENSITYDOM.01 density-driven dominance: %d passed, %d failed ---"
