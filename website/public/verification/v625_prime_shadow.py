#!/usr/bin/env python3
"""v625 -- PRIME.SHADOW.01: the prime-shadow audit -- the checkable core
of the "primes are the shadow of the finished geometry" reading is
EXACT: the
...
FIREWALL: no marker changes; the speculative framings stay typed
hypotheses; no RH statement.

PROVENANCE: discovery probe prime_shadow_probe.py (2026-08-02, 6/6,
verdict PRIME-SHADOW-EXACT); external note 2026-08-02.
