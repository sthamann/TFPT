#!/usr/bin/env python3
"""v623 -- QGEO.COVERSEAM.01: the covered seam round -- the lattice
skeleton of the covering-level identification: the lifted seam is ONE
48-site NS circle, the lifted clock has order 12 with L^4 = deck (the
lattice avatar of r^4 = omega), and the deck-character mode grid is the
12-grid with the untwisted sector equal to the base seam verbatim.

The named residue of v622, first executed slice.
...
PROVENANCE: discovery probe covered_seam_probe.py (2026-08-01, 9/9,
