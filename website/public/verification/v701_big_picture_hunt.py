#!/usr/bin/env python3
"""v701 -- PRIME.KEYSTONE.01: BIG-PICTURE HUNT -- cheap machine reads for the deep-analysis
...
PROVENANCE: discovery probe big_picture_hunt_probe.py (2026-08-03,
11/11 PASS: the keystone -- B = sine-moment form(c + pole) + rank-1
pole square EXACT; the three named gaps collapse onto ONE (defect
positivity modulo the operator question); the triplication identity
(the zeta arch = the mean of three digamma channels on the zeta_12
grid, mu_3-unique); the V5 fixpoint numerology dead, PSLQ empty).
