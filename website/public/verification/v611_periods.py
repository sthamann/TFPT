#!/usr/bin/env python3
"""v611 -- QGEO.PERIODS.01: the periods round -- the analytic layer of the
cover is classical -- all
...
PROVENANCE: discovery probe periods_probe.py (2026-08-01, 6/6, verdict
PERIODS-CLASSICAL).  Python-only,
