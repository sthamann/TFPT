...
const ROWS: Row[] = [
  ...
  },
  {
    ...
    status: "Honest handles — Koide, m_p/m_e, dark matter, now runnable typed solvers (v371–v375); the classical covariant field equation carries no free dimensionless Newton coupling under the named QFT/entanglement premises [C]; the ambient nonperturbative QG measure QG.AMB.01 is discharged as a redundancy [C] (v369+v379) and perturbative graviton unitarity is established [C] (v304/v370/v380)",
    paper: "Doc 4",
    tone: "conditional",
  },
  {
    layer: "Residual interfaces v_geo [O] closed metrology (R₊ torsor), G_net [C], F_transfer [C] — compiler rest; Rest_TOE / TFPT.TOE.COMPLETE.01 is the named [O] AND of eight gates, not a closure",
    status: "Numbered research contracts — the scale anchor (CLOSED METROLOGY STRUCTURE: R₊ unit torsor; one dimensionful calibration necessary by dimensional analysis — No-Unit v153/v725; unit choice closed; dimensionless hierarchies (M_Pl/v_EW, M_R/M_scal, Λ_QCD/v_EW, T_reh/M_scal) remain predictive obligations; display stays [O], no physical [E]; interface structurally closed as an R₊ scale torsor in calibration form, v725), the metric inclusion (route split: MMST route SEAM.EQUIV.MMST.01 closed modulo cited theorems, twistor route SEAM.EQUIV.TWISTOR.01 open with its measure chain now DERIVED at probe level (v520/v523: single-valuedness from F-independence + Quillen, 1/det_j the Atiyah–Bott fixed-point factor, ψ = 64), parent SEAM.EQUIV.01 [O] as an unconditional claim; extension leg on peer-reviewed crossed-product theorems, v469; OS twistor bridge WOIT.OS.TWISTOR.01 with α/β₁/β₂ executed, β₃ next under the straddle-law constraint — the straddle filter since executed as a selector: RP keeps exactly one member alive, δ = π/2, the alignment bit (v534, toy-fenced) — v519/v522/v524/v529/v534, stays [O]) and the transfer functor [C] (both thermal-time internalization routes machine-killed, v723/v724 — the external clock contract confirmed; first exact G_net index witnesses v722/v726)",
    paper: "Doc 8",
    tone: "downstream",
  },
];
