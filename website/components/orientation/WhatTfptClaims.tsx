...
const NOT_CLAIMS = [
  ...
  "The frontier items — η_B, m_p/m_e, Koide, dark matter — are honest handles, not forced compiler powers, now runnable typed solvers (F_transfer = F_pole ⊕ F_Boltzmann ⊕ F_relic ⊕ F_QCD, v371–v374) with kill tests; the classical covariant field equation carries no free dimensionless Newton coupling under the named QFT/entanglement premises [C] (Gₐᵦ + Λgₐᵦ = c₃⁻¹Tₐᵦ, both coefficients fixed under those premises).",
  "No strict physical TOE is certified end-to-end: the keystone SEAM.EQUIV.01 is closed only on its MMST route SEAM.EQUIV.MMST.01, modulo a cited published theorem (the cited continuum scaling-limit existence, v336; twistor route SEAM.EQUIV.TWISTOR.01 and the unconditional parent stay [O]; its 128-spinor extension leg is certified at net level by the peer-reviewed crossed-product package v469, with AGT/AMT an independent second witness — stays [O]), and v_geo is a CLOSED METROLOGY STRUCTURE (R₊ unit torsor; one dimensionful calibration necessary by dimensional analysis — No-Unit v153/v725; display stays [O], no physical [E]). The master contract TFPT.TOE.COMPLETE.01 [O] NAMES the AND of eight gates (T1–T8); TOE_Complete := AND(T1..T8) vs TOE_Validated := Complete AND independent holdouts passed — it does not close a TOE. Rest_TOE is the 2026-08-27/28 contract accounting (ten named [O] summands) sitting beside that AND. The ambient quantum-gravity measure (G6 / QG.AMB.01) is NOT the open completion target — it is discharged as a redundancy [C] (v369 + v379), a certification object, not missing dynamics.",
];
