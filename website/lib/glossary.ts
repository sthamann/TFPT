...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  },
  {
    ...
    short:
      "The historical seam/metric keystone: the raw reflection-positive seam state is identified with the holomorphic (E₈)₁ net at τ=i. The MMST route is [C], closed modulo cited theorems but not solved; the twistor route and unconditional parent remain [O]. Calling this ‘one keystone’ is lane-scoped: it neither closes T1–T8 nor constructs the missing shared 3+1D parent.",
  },
  {
    term: "Rest_TOE",
