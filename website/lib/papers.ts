...
export const papers: Paper[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        formulas: [
          ...
          "G_0=(1+Y)/(1-Y)=\\zeta_p(w-3)^2/\\zeta_p(2w-6),\\quad Q_{\\mathrm{fam}}=2Q_\\zeta(g)-2Q_\\zeta(g_\\flat)+\\mathrm{Arch}+\\mathrm{Corr}",
        ],
      },
      {
  ...
  },
  {
    ...
    highlights: [
      ...
      { label: "muon a_μ", value: "2.879×10⁻⁹", description: "Seam vertex δ₂/(2π); bridge dissolved 2026-08-04 (WP25+BMW lattice consensus, exp−SM 0.5σ) [X] — exact value and core untouched" },
