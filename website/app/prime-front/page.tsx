...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Primes, the E8 census, and the load-bearing modules v535–v935: Hecke from geometry, the phase-2 certified map, C = 1 exception-free, the Lorentz congruence, the E8 code dictionary, and the Suzuki W1 identification theorem-closed (after a same-day convention erratum). Honest fence: closing W1 does not move W3. No claim of progress toward the Riemann Hypothesis.",
  ...
  twitter: {
    ...
    description:
      "Research diary of the prime / zeta line. Machine-verified v535–v935: the induction sprint, the phase-2 map, C = 1, the Lorentz bridge, the E8 code, and the Suzuki W1 theorem (erratum-corrected one-scalar dictionary) — with the RH-hard step W3 explicitly open. Not RH evidence.",
  },
};
    ...
    >
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 max-w-3xl border-l-2 border-sky-400/40 pl-3 text-[15px] leading-relaxed text-slate-400">
          ...
          no promotion, no marker moves — the suite stood at 906 at the freeze (928 today). No RH
    ...
    >
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 max-w-3xl border-l-2 border-sky-400/40 pl-3 text-[15px] leading-relaxed text-slate-400">
          ...
          cap typed in verbatim); the suite stands at 928 (after the later v916/v917 Epstein detection-arc, v918–v921 theorem-arc, v922–v925 spectral-balance/edge arc, v926–v930 endgame-arc and v931–v935 triple-cofinal-arc promotions). Everything else
    ...
    >
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 max-w-3xl border-l-2 border-sky-400/40 pl-3 text-[15px] leading-relaxed text-slate-400">
          ...
          v915_eulerpick_certified_floors.py; the suite stands at 928. The
    ...
    >
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 max-w-3xl border-l-2 border-sky-400/40 pl-3 text-[15px] leading-relaxed text-slate-400">
          ...
          the suite stood at 906 at these rounds&apos; freeze (928 today,
          after the v914/v915 and later promotions through v935). No RH claim in
          any direction.
        </p>
