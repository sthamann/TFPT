...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Primes, the E8 census, and the load-bearing modules v535–v921: Hecke from geometry, the phase-2 certified map, C = 1 exception-free, the Lorentz congruence, the E8 code dictionary, and the Suzuki W1 identification theorem-closed (after a same-day convention erratum). Honest fence: closing W1 does not move W3. No claim of progress toward the Riemann Hypothesis.",
  ...
  twitter: {
    ...
    description:
      "Research diary of the prime / zeta line. Machine-verified v535–v921: the induction sprint, the phase-2 map, C = 1, the Lorentz bridge, the E8 code, and the Suzuki W1 theorem (erratum-corrected one-scalar dictionary) — with the RH-hard step W3 explicitly open. Not RH evidence.",
  },
};
    ...
    >
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 max-w-3xl border-l-2 border-sky-400/40 pl-3 text-[15px] leading-relaxed text-slate-400">
          ...
          (914 today, after the v914/v915 promotion of chapters 37–39, the v916/v917 Epstein detection-arc promotion of 2026-08-16 and the v918–v921 prime-front theorem-arc promotion of 2026-08-18).
        </p>
    ...
    >
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 max-w-3xl border-l-2 border-sky-400/40 pl-3 text-[15px] leading-relaxed text-slate-400">
          ...
          no promotion, no marker moves — the suite stood at 906 at the freeze (914 today). No RH
    ...
    >
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 max-w-3xl border-l-2 border-sky-400/40 pl-3 text-[15px] leading-relaxed text-slate-400">
          ...
          cap typed in verbatim); the suite stands at 914 (after the later v916/v917 Epstein detection-arc and v918–v921 theorem-arc promotions). Everything else
    ...
    >
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 max-w-3xl border-l-2 border-sky-400/40 pl-3 text-[15px] leading-relaxed text-slate-400">
          ...
          v915_eulerpick_certified_floors.py; the suite stands at 914. The
    ...
    >
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 max-w-3xl border-l-2 border-sky-400/40 pl-3 text-[15px] leading-relaxed text-slate-400">
          ...
          the suite stood at 906 at these rounds&apos; freeze (914 today,
