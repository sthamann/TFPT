...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Primes, the E8 census, and the load-bearing modules v535–v948: Hecke from geometry, the phase-2 certified map, C = 1 exception-free, the Lorentz congruence, the E8 code dictionary, and the Suzuki W1 identification theorem-closed (after a same-day convention erratum). Honest fence: closing W1 does not move W3. No claim of progress toward the Riemann Hypothesis.",
  ...
  twitter: {
    ...
    description:
      "Research diary of the prime / zeta line. Machine-verified v535–v948: the induction sprint, the phase-2 map, C = 1, the Lorentz bridge, the E8 code, and the Suzuki W1 theorem (erratum-corrected one-scalar dictionary) — with the RH-hard step W3 explicitly open. Not RH evidence.",
  },
};
    ...
    >
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 max-w-3xl border-l-2 border-sky-400/40 pl-3 text-[15px] leading-relaxed text-slate-400">
          ...
          (941 today, after the v914/v915 promotion of chapters 37–39, the v916/v917 Epstein detection-arc promotion of 2026-08-16, the v918–v921 prime-front theorem-arc promotion of 2026-08-18, the v922–v925 spectral-balance/edge arc and v926–v930 endgame-arc promotions of 2026-08-19, the v931–v935 triple-cofinal-arc and v936–v941 post-bughunt-arc promotions of 2026-08-20, and the v942–v948 mechanism-arc promotion of 2026-08-21).
        </p>
    ...
    >
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 max-w-3xl border-l-2 border-sky-400/40 pl-3 text-[15px] leading-relaxed text-slate-400">
          ...
          no promotion, no marker moves — the suite stood at 906 at the freeze (941 today). No RH
    ...
    >
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 max-w-3xl border-l-2 border-sky-400/40 pl-3 text-[15px] leading-relaxed text-slate-400">
          ...
          cap typed in verbatim); the suite stands at 941 (after the later v916/v917 Epstein detection-arc, v918–v921 theorem-arc, v922–v925 spectral-balance/edge arc, v926–v930 endgame-arc, v931–v935 triple-cofinal-arc, v936–v941 post-bughunt-arc and v942–v948 mechanism-arc promotions). Everything else
    ...
    >
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 max-w-3xl border-l-2 border-sky-400/40 pl-3 text-[15px] leading-relaxed text-slate-400">
          ...
          v915_eulerpick_certified_floors.py; the suite stands at 941. The
    ...
    >
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 max-w-3xl border-l-2 border-sky-400/40 pl-3 text-[15px] leading-relaxed text-slate-400">
          ...
          the suite stood at 906 at these rounds&apos; freeze (941 today,
          after the v914/v915 and later promotions through v948). No RH claim in
          any direction.
        </p>
