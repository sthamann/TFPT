...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Primes, the E8 census, and the load-bearing modules v535–v872: Hecke from geometry, the phase-2 certified map, C = 1 exception-free, the Lorentz congruence, the E8 code dictionary, and the Suzuki W1 identification theorem-closed (after a same-day convention erratum). Honest fence: closing W1 does not move W3. No claim of progress toward the Riemann Hypothesis.",
  ...
  twitter: {
    ...
    description:
      "Research diary of the prime / zeta line. Machine-verified v535–v872: the induction sprint, the phase-2 map, C = 1, the Lorentz bridge, the E8 code, and the Suzuki W1 theorem (erratum-corrected one-scalar dictionary) — with the RH-hard step W3 explicitly open. Not RH evidence.",
  },
};
      ...
      <section className="relative isolate overflow-hidden pt-12 pb-8 sm:pt-16">
        ...
        <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-sky-300/90">
            Research diary · 250 agent runs · 6638 sandbox checks · suite 817
            scripts
          </p>
    ...
    >
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-6 max-w-3xl text-sm leading-relaxed text-slate-500">
          ...
          positivity ⇒ Weil positivity ⇒ the target, theorem-grade
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8">
          ...
          <dl className="mt-3 grid grid-cols-2 gap-3 sm:grid-cols-4">
            ...
            <BigPictureStat
              term="v535–v872"
              desc="machine-verified modules of this front, inside the 865-script suite (all green)"
              tone="emerald"
            />
            <BigPictureStat
              term="96.2%"
