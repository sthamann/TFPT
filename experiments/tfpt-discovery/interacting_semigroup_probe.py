#!/usr/bin/env python3
"""Discovery probe: the interacting Klein-Landau semigroup -- the clock
survives the interaction as a positive transfer exactly on the
mu4-commensurate steps.  (WOIT gamma milestone, the net-dynamics slice
after v615/v616.)
