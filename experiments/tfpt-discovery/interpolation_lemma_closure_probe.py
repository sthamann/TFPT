"""Discovery probe: CLOSING THE TWO NAMED BUILDING BLOCKS of the
alias-interpolation lemma (PRIME.W3.INTERPOLATION.01, follow-up):
...
NO RH claim; experiments-only; Python-only per GATE.WOLFRAM.02.

Provenance: interpolation_detector_probe.py (2026-08-03, the parent:
