"""Discovery probe: OFFENSIVE 2e -- CLOSING T-B(block) WITH CITED
EXPLICIT ZERO-DENSITY BOUNDS.
...
FIREWALL: only this new file; everything else read-only.  No RNG,
no marker moves.  Zeros <= 2e4 computed (RvM-checked); beyond:
citations only.

Provenance: rank3_lockgram_probe.py (2d machinery, imported
read-only), v563/v677 corpus, citations [A1]-[A6] above.
"""
import math
import os
import sys
