"""Discovery probe: the flip mechanics round -- the two C = 1 violators
are truncation artifacts of the prime-data cap, reproduced by injection;
on the complete-comb surface the constant C = 1 holds with ZERO
exceptions.  (PRIME front, the mechanism behind the v618 dichotomy.)
