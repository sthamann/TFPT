#!/usr/bin/env python3
"""Discovery probe: the seam identification round -- the physical seam IS
the conformal seam: the v519 kernel is the exact discrete NS conformal
correlator, and the full combinatorial dictionary (sites, marks, cuts,
clock, straddle law) is exact geometry.  (The second v617 bedrock
residue, closed at the kernel + dictionary level.)
