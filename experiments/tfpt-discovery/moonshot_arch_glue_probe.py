#!/usr/bin/env python3
"""MOONSHOT stage 2 -- the shared arch-sector test (kill (c) head-on).
...
no ledger row, no paper claim.  Run:
    experiments/tfpt-discovery/.venv/bin/python \
        experiments/tfpt-discovery/moonshot_arch_glue_probe.py
"""
...
import moonshot_hecke_groupoid_probe as stage1  # noqa: E402
