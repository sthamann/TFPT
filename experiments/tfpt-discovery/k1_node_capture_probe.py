#!/usr/bin/env python3
"""k1_node_capture_probe.py -- K1 SLICE: the node-capture lemma behind
...
Provenance (read-only): moonshot_spectral_probe (E4 machinery,
family/gns/targets reused verbatim), v668/v669 (Fejer identity),
v678 (zero gap), v688 (falsifier, cited in typing), z1_jacobi
(Wheeler/Levinson).
"""
import ast
import hashlib
...
import moonshot_spectral_probe as e4  # noqa: E402  (E4 lab, read-only)
