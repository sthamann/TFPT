#!/usr/bin/env python3
"""The selection rule round: the deck rotation has a UNIQUE projective
eigenline on the infinity torsion -- the top mode -- and the zero mode is
the only unlabeled mode: the canonical "+1" rule.
