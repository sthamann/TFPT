"""Discovery probe: HECKE-EQUIVARIANT SUM OF SQUARES -- OFFENSIVE 4 /
PRIME.W3.HECKE.SOS.01: search for the prime-local, Hecke-equivariant
square-sum factorisation of the deployed Weil window form,
...
FIREWALL: experiments-only; verification/ read-only (v563 import, same
pattern as lk_split_theta_probe / epstein_firewall_probe); NO zero of
...
lk_split_theta_probe (offensive 1: sign bookkeeping, spike law, mean
form), geometric_sos_probe (offensive 3: Hecke channels, T_p census),
rank3_functionals_probe (offensive 2: locked cancellation),
