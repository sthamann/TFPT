"""Discovery probe: WHAT DRIVES THE ALIGNMENT FACTOR r_id?  The
margin-bridge round (margin_link_probe, 2026-08-02) identified the
...
v618/v591/margin machinery REBUILT verbatim, no other imports); no
...
Provenance: margin_link_probe (2026-08-02, BRIDGE mechanism + r_id
quotes); sign_uncertainty_w3_probe (floor machinery); v618 (C = 1
reads); v591 (closed lock direction); v637 (control methodology).
"""
import ast
import math
import os
