#!/usr/bin/env python3
"""MOONSHOT ETAPPE 4 -- the spectral identification: do the eigenvalues
...
run_all.py, no ledger row, no paper claim.  Run:
    experiments/tfpt-discovery/.venv/bin/python \
        experiments/tfpt-discovery/moonshot_spectral_probe.py
"""
...
import z1_jacobi_probe as jac  # noqa: E402  (Wheeler/Levinson, locked)
