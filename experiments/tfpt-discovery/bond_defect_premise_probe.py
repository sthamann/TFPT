#!/usr/bin/env python3
"""Discovery probe: HARDENING THE BOND-DEFECT PREMISE -- the last [C] of
the orbifold front (orbifold_arf_probe.py A4.1): "the premise that the
...
Conventions inherited read-only from orbifold_arf_probe.py,
orbifold_assembly_probe.py, v622/v623/v628/v639.  Bond b = the pair
