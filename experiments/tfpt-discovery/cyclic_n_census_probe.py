#!/usr/bin/env python3
"""Discovery probe: the cyclic-N census -- the seam admits N = 3 and
N = 5 as Lorentz orders, and the compiler's machine-checked integral
constants pin N = 3.  (The first of the two named v617 bedrock
residues, made conditional.)
