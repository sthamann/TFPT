"""Discovery probe: W2 MOSCO / NORM-RESOLVENT PREPARATION -- measurable
surrogates for the typed W2 remainder of w2_form_density_probe (iv)(a)
and (iv)(b), at the fixed window a = alpha(h = 184) = log 16 on the
dyadic ladder M = 92/184/368/736.
...
no marker moves; Python-only, counted per GATE.WOLFRAM.02.
"""
import math
import os
import sys
