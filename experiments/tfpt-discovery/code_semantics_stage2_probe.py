#!/usr/bin/env python3
"""Stage-2 sandbox probe -- exploit-or-kill for the UNIQUE equivariant
Hamming placement C* found by code_semantics_kill_probe.py.
...
Exact arithmetic throughout (int / Fraction).  Sandbox: writes nothing.
"""
