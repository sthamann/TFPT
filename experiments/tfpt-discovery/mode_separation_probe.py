#!/usr/bin/env python3
"""The mode-separation round: the infinity torsion separates the three
V-eigenlines (the selection carrier the real structure could not provide),
and the cubic field of c is honestly non-abelian.
