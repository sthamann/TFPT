#!/usr/bin/env python3
"""Discovery probe: the seam forcing round -- the conformal seam axioms
force the mu3-cover y^3 = x^4 - 1 up to the conjugate sheet.  (A
constructive slice of the bedrock premise QGEO.SYM.01.)
