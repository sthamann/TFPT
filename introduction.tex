...
response map.  Remaining axiom-core and continuum gaps now run through one externalized
theorem (MMST/Quillen).
...
for finite-group DET chains.  Remaining fundamental gaps route through one externalized
