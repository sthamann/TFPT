...
Round-3 TOE integration (2026-09-05;
...
T2 now has C1, C2a and the interval-TV input closed and the analytic scalar C2b
budget executed, while CF, DG and ALG-EXH remain open and the old ALG2 Vandermonde
implication is refuted.  T4 gains only a finite derivative-filtered quasi-free block
(no invariant bare-mirror gap, Weyl cone, DET realization, measure or continuum).
T6 gains a parent-internal intertwiner with a projective full-Fock lift but no mass
texture; T7 gains uniform-gap/direct-TT no-gos but no graviton; T8 gains an arbitrary
$D_4$-breaking internal $\mathbb Z_5$ cap but no global $\rho_0$.  T1 retains only
...
confinement and scattering remain open.  These are finite subgate certificates and
